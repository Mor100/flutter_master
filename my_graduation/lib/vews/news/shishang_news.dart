...
class ShishangNews extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ShishangNewsState();
  }
}

class _ShishangNewsState extends State<ShishangNews>
    with AutomaticKeepAliveClientMixin {
  var _url =
      'http://v.juhe.cn/toutiao/index?type=shishang&key=c39989f9ba103c0cfea89eca5d6e0d55';
  ...
  Widget _listItem(BuildContext context, int index) {
    ...
    return CustomLayout.listItemRightPic(data,context);
  }
