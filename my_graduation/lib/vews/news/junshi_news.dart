...
class JunshiNews extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _JunshiNewsState();
  }
}

class _JunshiNewsState extends State<JunshiNews>
    with AutomaticKeepAliveClientMixin {
  var _url =
      'http://v.juhe.cn/toutiao/index?type=junshi&key=c39989f9ba103c0cfea89eca5d6e0d55';
  ...
  Widget _listItem(BuildContext context, int index) {
    ...
    return CustomLayout.listItemAllPic(data, context);
  }
