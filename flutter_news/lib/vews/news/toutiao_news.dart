...
class ToutiaoNews extends StatefulWidget {
  ...
  ToutiaoNews({this.context});

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ToutiaoNewsState();
  }
}
...
class _ToutiaoNewsState extends State<ToutiaoNews>
  ...
  var _url =
      'http://v.juhe.cn/toutiao/index?type=top&key=c39989f9ba103c0cfea89eca5d6e0d55';
  ...
  Widget _listItem(BuildContext context, int index) {
    ...
    return CustomLayout.listItemAllPic(data,widget.context);
  }
